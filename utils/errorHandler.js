...
const ErrorCodes = exports.ErrorCodes = {
  ...
  UPLOAD_EMPTY_ARRAY: {
    code: 2005,
    message: "JSON muss ein Array mit Posts sein",
    status: 400
  },
  UPLOAD_FAILED: {
    code: 2006,
  ...
  POSTS_EMPTY: {
    code: 3002,
    message: "Keine Posts vorhanden. Bitte zuerst Daten hochladen.",
    status: 400
  },
  // AI Generation Errors (4xxx)
  AI_NO_PROMPTS: {
    code: 4001,
    message: "Keine Prompts angegeben",
    status: 400
  },
  ...
  AI_NO_RESPONSE: {
    code: 4003,
    message: "Keine Antwort von der KI erhalten",
    status: 500
  },
  AI_RATE_LIMITED: {
    code: 4004,
...
function createErrorResponse(errorType, details = null) {
